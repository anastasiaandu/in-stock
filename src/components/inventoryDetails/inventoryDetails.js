                ...
                <div className='inventory__container'>
                    <div className="inventory__titles">
                        ...
                        <div className="inventory__category-heading">
                            ...
                            <p className="inventory__detail inventory__detail--bottom">{this.state.category}</p>
                        </div>
                    </div>
                    <div className="inventory__details">
                        <div className="inventory__status-heading">
                            <h4 className="inventory__subtitle--mobile">Status:</h4>
                            <div className={`inventory__highlight ${this.state.status === "In Stock" ? "inventory__highlight--green" : "inventory__highlight--red"}`}>
                                <h4 className={`inventory__stock ${this.state.status === "In Stock" ? "inventory__stock--green" : "inventory__stock--red"}`}>{this.state.status}</h4>
                            </div>
                        </div>
                        <div className="inventory__warehouse-heading">
                            <h4 className="inventory__subtitle--mobile">Warehouse:</h4>
                            <p className="inventory__detail inventory__detail--bottom">{this.state.warehouseName}</p>
                        </div>
